use crate::kinode::process::file_transfer_template::{Request as TransferRequest, Response as TransferResponse};
...
fn init(_our: Address) {
    ...
    if who.is_empty() {
        println!("usage: list_files:file_transfer_template:diligence.os who");
        return;
    }
